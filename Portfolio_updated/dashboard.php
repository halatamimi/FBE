    ...
    <div class="row">
      ...
      <main class="ms-sm-auto col-lg-12 px-md-4 content-container">      
          ...
          <h2 style="margin-top:1em;">Profile</h2>
            <form action="dashboard.php" method="POST" id="form-container">
            <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="" id="aboutText" name="aboutText" rows="3" placeholder="About yourself"><?php echo $site->aboutText; ?></textarea>
                </div>

                <div class="mb-3">
                    <label for="age" class="form-label">Age</label>
                    <input type="number" class="form-control" id="github-link" name="age" placeholder="Age" value="<?php echo $user->age; ?>">
                </div>

                <div class="mb-3">
                  <label for="available">Freelance</label>
                  <br>
                  <select name="available" id="available">
                    <option value="1" <?php echo $user->experience == true ? "selected" : ""; ?>>Available</option>
                    <option value="0" <?php echo $user->experience == false ? "selected" : ""; ?>>Unvailable</option>
                  </select>
                </div>

                <div class="mb-3">
                    <label for="location" class="form-label">Location</label>
                    <input type="text" class="form-control" id="location" name="location" placeholder="Your Location" value="<?php echo $user->location; ?>">
                </div>
                <br>
      ...
      case "project":
        formContentElement.innerHTML = `
          <form action="cardsManage.php" method="POST">
            ...
            <input type="text" class="form-control" id="demoLink" name="demoLink" placeholder="Demo Link">
